          ...
          <nav className="u-sp-only">
            ...
            {isOpen && (
              <div className="mobile-menu">
                <Link to="/" onClick={handleTopClick}>{t('header.top')}</Link>
                <HLink smooth to="/#about-section" onClick={() => setIsOpen(false)}>{t('header.about')}</HLink>
                <Link to="/staff" onClick={() => setIsOpen(false)}>{t('header.staff')}</Link>
                <HLink smooth to="/#media-section" onClick={() => setIsOpen(false)}>{t('header.media')}</HLink>
                <HLink smooth to="/#contact-section" onClick={() => setIsOpen(false)}>{t('header.contact')}</HLink>
              </div>
            )}
            </nav>
          <LangSwitch />
